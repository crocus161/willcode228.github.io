...
exports.default = parallel(style, normalize, scripts, images, toWebp,  browsersync, startWatch);

//****************build task*****************
// exports.build = series(style, scripts, toWebp, images, buildcopy);
exports.build = series(htmlMin, style, scripts, images, toWebp, buildcopy);
